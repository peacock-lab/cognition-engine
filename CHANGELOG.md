...
8. 公仓公开材料保持项目级用户材料口径，不把 `packages/*/README.md` 作为本轮同步材料；
9. 新增包稳定前暂不采用 Trusted Publishing，后续 PyPI 发布仍需显式人工授权；
...
`v0.8.0` 是上一轮产品发布候选版本号，当前只保留为 v0.8.1 前的发布线记录。
