...
from cognition_operation_flows._external_readonly.evidence import (
    ...
    review_operation_flow_external_readonly_evidence_item,
...
def test_evidence_envelope_projects_only_sanitized_model_context() -> None:
    ...
    status = operation_flow_external_readonly_evidence_envelope_status_dict(envelope)
...
def test_item_review_blocks_invalid_source_timestamp_ref_and_hash() -> None:
    review = review_operation_flow_external_readonly_evidence_item(
        _valid_item(
...
def _valid_item(**overrides: object) -> OperationFlowExternalReadonlyEvidenceItemCandidate:
    excerpt = str(
        overrides.get(
            "sanitized_excerpt",
    ...
    return OperationFlowExternalReadonlyEvidenceItemCandidate(**kwargs)
...
def _valid_design() -> OperationFlowExternalReadonlyToolDesignCandidate:
    return OperationFlowExternalReadonlyToolDesignCandidate(
...
def _valid_request(**overrides: object) -> OperationFlowExternalReadonlyNetworkRequestCandidate:
    kwargs = {
...
def _valid_approval() -> OperationFlowExternalReadonlyNetworkApprovalCandidate:
    return OperationFlowExternalReadonlyNetworkApprovalCandidate(
