"""Runtime-container facade for governed LLM invocation."""
...
class RuntimeContainerLlmInvocationFacade:
    """Thin facade over runtime governed LLM invocation organization."""

    service: GovernedLlmInvocationService
    metadata: dict[str, Any] = field(default_factory=dict)

    def run(self, request: LlmInvocationRequest) -> LlmInvocationResult:
        """Run a no-live governed invocation through runtime."""

        return run_runtime_container_llm_invocation(
    ...
    def to_metadata(self) -> dict[str, Any]:
        ...
        return {
            "facade": "runtime_container.llm_invocation_facade",
...
def build_runtime_container_llm_invocation_request(
    *,
    request_id: str,
    ...
    """Build public request facts through the runtime organization helper."""
...
def run_runtime_container_llm_invocation(
    *,
    service: GovernedLlmInvocationService,
