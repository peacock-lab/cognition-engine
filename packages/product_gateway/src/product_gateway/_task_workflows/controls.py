...
INTERNAL_REFERENCE_READER_TOOL_NAME = TWF_PRODUCT_ENTRY_REFERENCE_READER_TOOL_NAME
...
def resolve_internal_twf_tool_exposure_profile(
    *,
    ...
    resolution = resolve_twf_product_entry_tool_exposure_profile(
...
def build_internal_twf_tools_status(
    *,
    ...
    return build_twf_product_entry_tools_status(
        profile_name=profile_name,
        profile_config=profile_config,
        repo_root=repo_root,
        entrypoint_explicit_args=entrypoint_explicit_args,
...
def build_internal_twf_skill_capability_projection_status() -> dict[str, Any]:
    ...
    return build_twf_product_entry_skill_capability_projection_status()
