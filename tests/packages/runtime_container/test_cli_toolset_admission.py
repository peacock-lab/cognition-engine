...
from runtime_container.cli_toolset_admission import (
    ...
    cli_toolset_inventory_status_dict,
...
def test_readonly_external_operation_is_allowed_with_confirmation() -> None:
    review = review_cli_tool_operation_risk(
        CliToolOperationFactsCandidate(
...
def test_camel_case_operation_id_is_split_for_risk_review() -> None:
    readonly = review_cli_tool_operation_risk(
        CliToolOperationFactsCandidate(
            tool_name="list_customers",
            toolset_name="api_hub_customer",
            toolset_kind="api_hub",
    ...
    side_effect = review_cli_tool_operation_risk(
        CliToolOperationFactsCandidate(
            tool_name="create_customer",
            toolset_name="api_hub_customer",
            toolset_kind="api_hub",
...
def test_inventory_exposes_only_selected_readonly_tools() -> None:
    ...
    inventory = build_cli_toolset_inventory(
        admission,
        (
            CliToolOperationFactsCandidate(
                tool_name="list_customers",
    ...
    status = cli_toolset_inventory_status_dict(inventory)
