"""Default external-readonly ask provider factory assembly."""
...
DEFAULT_EXTERNAL_READONLY_ASK_LLM_INVOCATION_PROVIDER_FACTORY_REF = (
    "product_runtime_assembly.external_readonly_ask_provider_factory.default"
)


@dataclass(frozen=True)
class ProductRuntimeAssemblyExternalReadonlyAskLlmInvocationServiceFactory:
    """Lazy default factory for external-readonly ask LLM services."""
...
def build_external_readonly_ask_default_llm_invocation_service_factory(
    *,
    metadata: Mapping[str, Any] | None = None,
) -> GovernedLlmInvocationServiceFactory:
    """Build the default external-readonly ask LLM provider factory."""
    ...
    return ProductRuntimeAssemblyExternalReadonlyAskLlmInvocationServiceFactory(
