...
ENABLE_REAL_PROVIDER_SMOKE_ENV = "CE_ENABLE_OPERATION_FLOW_CONTROLLED_LIVE_REAL_PROVIDER_SMOKE"
DEFAULT_OLLAMA_API_BASE = "http://127.0.0.1:11434"
DEFAULT_TIMEOUT_SECONDS = "180"
TIMEOUT_SECONDS_ENV = "CE_OPERATION_FLOW_CONTROLLED_LIVE_REAL_PROVIDER_TIMEOUT_SECONDS"
...
def test_cli_operation_flow_plan_workflow_real_provider_smoke(
    case_id: str,
    stdin_text: str,
    ...
    output = _run_real_operation_flow_plan_smoke(case_id=case_id, stdin_text=stdin_text)
...
def test_cli_operation_flow_reference_review_real_provider_smoke() -> None:
    _skip_unless_real_provider_smoke_enabled()

    output = _run_real_operation_flow_reference_review_smoke()
...
def _run_real_operation_flow_plan_smoke(*, case_id: str, stdin_text: str) -> str:
...
def _run_real_operation_flow_reference_review_smoke() -> str:
    ollama_api_base = _local_ollama_api_base(
        os.getenv("CE_OLLAMA_API_BASE", DEFAULT_OLLAMA_API_BASE)
    )
    timeout_seconds = _timeout_seconds()
