    ...
    def invoke(self, request: LlmInvocationRequest) -> LlmInvocationResult:
        ...
        return LlmInvocationResult(
            ...
            metadata={
                ...
                "source": "test_twf_controlled_live_fake_smoke",
            },
        )
...
def test_cli_chat_plan_live_twf_uses_injected_fake_factory(
    monkeypatch: Any,
    capsys: Any,
    tmp_path: Path,
) -> None:
    ...
    exit_code = cognition.run_cli(
        _allowed_chat_args(
            ...
            "approval://cli-twf-plan-fake-live",
            "--ollama-api-base",
...
def test_cli_chat_reference_review_live_twf_uses_injected_fake_factory(
    monkeypatch: Any,
    capsys: Any,
) -> None:
    service = FakeControlledLiveService(
    ...
    exit_code = cognition.run_cli(
        _allowed_chat_args(
            "--chat-session-id",
            "cli-twf-reference-review-fake-live-smoke",
            "--reference-path",
            ...
            "--allow-ollama",
            "--live-llm-approval-ref",
            "approval://cli-twf-reference-review-fake-live",
            "--ollama-api-base",
            "http://127.0.0.1:11434",
            "--live-llm-timeout-seconds",
            "12",
