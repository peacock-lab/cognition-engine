"""Candidate-only admission gate for CLI agent workflows."""
...
from runtime_container.cli_task_control import MANAGED_GOVERNANCE_PARAMETERS
...
class AgentWorkflowLoadingGateCandidate:
    """Aggregate loading gate for a candidate CLI agent workflow."""
...
def build_agent_workflow_descriptor(
    *,
    ...
    description: str = "Candidate CLI agent workflow descriptor.",
...
def evaluate_agent_team_admission(
    *,
    ...
    """Evaluate an agent team before it can become a CLI workflow engine."""
