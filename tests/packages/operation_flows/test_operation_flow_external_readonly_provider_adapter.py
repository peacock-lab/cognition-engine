...
from cognition_operation_flows._external_readonly.network_gate import (
    OperationFlowExternalReadonlyNetworkApprovalCandidate,
    OperationFlowExternalReadonlyNetworkRequestCandidate,
    evaluate_operation_flow_external_readonly_network_gate,
)
from cognition_operation_flows._external_readonly.provider_adapter import (
    OperationFlowExternalReadonlyFakeProviderRecordCandidate,
    OperationFlowExternalReadonlyProviderProfileCandidate,
    OperationFlowExternalReadonlyProviderRequestCandidate,
    run_operation_flow_external_readonly_fake_provider_adapter,
    operation_flow_external_readonly_provider_adapter_result_status_dict,
)
...
def test_fake_search_provider_projects_records_into_evidence_envelope() -> None:
    result = run_operation_flow_external_readonly_fake_provider_adapter(
        gate=_passed_gate(),
    ...
    status = operation_flow_external_readonly_provider_adapter_result_status_dict(result)
...
def test_fake_provider_blocks_operation_mismatch_and_missing_query_or_source() -> None:
    search_result = run_operation_flow_external_readonly_fake_provider_adapter(
        gate=_passed_gate(),
        profile=OperationFlowExternalReadonlyProviderProfileCandidate(
            provider_name="fake_fetch_provider",
            provider_kind="fake_fetch",
    ...
    missing_query = run_operation_flow_external_readonly_fake_provider_adapter(
        gate=_passed_gate(),
        profile=_search_profile(),
...
def _search_profile() -> OperationFlowExternalReadonlyProviderProfileCandidate:
    return OperationFlowExternalReadonlyProviderProfileCandidate(
...
def _provider_request(**overrides: object) -> OperationFlowExternalReadonlyProviderRequestCandidate:
    kwargs = {
    ...
    return OperationFlowExternalReadonlyProviderRequestCandidate(**kwargs)


def _record(**overrides: object) -> OperationFlowExternalReadonlyFakeProviderRecordCandidate:
    kwargs = {
        "evidence_ref": "evidence://external-readonly/fake-search/1",
        "source_url": "https://example.com/reference",
    ...
    kwargs.update(overrides)
    return OperationFlowExternalReadonlyFakeProviderRecordCandidate(**kwargs)
...
def _passed_gate(
    *,
    ...
    return evaluate_operation_flow_external_readonly_network_gate(
