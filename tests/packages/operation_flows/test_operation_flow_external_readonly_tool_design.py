...
from cognition_operation_flows._external_readonly.tool_design import (
    OPERATION_FLOW_EXTERNAL_READONLY_ALLOWED_OPERATIONS,
    OPERATION_FLOW_EXTERNAL_READONLY_ALLOWED_ORIGINS,
    OperationFlowExternalReadonlyToolDesignCandidate,
    build_operation_flow_external_readonly_tool_design_summary,
    review_operation_flow_external_readonly_tool_design,
    operation_flow_external_readonly_tool_design_summary_status_dict,
)
...
def test_google_search_and_url_context_are_design_allowed_without_execution() -> None:
    summary = build_operation_flow_external_readonly_tool_design_summary(
        (
    ...
    status = operation_flow_external_readonly_tool_design_summary_status_dict(summary)
...
def test_origin_operation_mismatch_is_blocked() -> None:
    search_fetch_review = review_operation_flow_external_readonly_tool_design(
        _valid_external_design(operation_family="fetch")
    )
    url_search_review = review_operation_flow_external_readonly_tool_design(
        _valid_external_design(
...
def test_external_design_requires_source_schema_adapter_and_evidence_boundaries() -> None:
    review = review_operation_flow_external_readonly_tool_design(
        OperationFlowExternalReadonlyToolDesignCandidate(
            tool_name="url_context_reference_read",
            tool_origin="url_context",
            operation_family="read",
