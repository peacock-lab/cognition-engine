...
def test_skill_projection_status_summary_blocks_escalated_context() -> None:
    summary = build_operation_flow_skill_projection_status_summary(
    ...
    assert status["source"] == "cognition_operation_flows._skills.projection_context"
...
def _projection() -> dict[str, object]:
    return {
        ...
        "allowed_workflow_names": (OPERATION_FLOW_PLAN_WORKFLOW_NAME,),
...
def _slot() -> dict[str, object]:
    return {
        "slot_ref": "workflow-skill-slot://operation_flow_plan_workflow/skill.plan.formatting",
