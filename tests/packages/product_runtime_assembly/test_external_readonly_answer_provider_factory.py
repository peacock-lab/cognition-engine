...
from product_runtime_assembly import external_readonly_answer_provider_factory
...
def test_external_readonly_answer_default_provider_factory_is_lazy_wrapper(
    monkeypatch: Any,
) -> None:
    ...
    monkeypatch.setattr(
        external_readonly_answer_provider_factory,
        "_build_runtime_container_llm_invocation_service_factory",
        fake_builder,
    )

    factory = build_external_readonly_answer_default_llm_invocation_service_factory(
        metadata={"request_id": "external-readonly-answer-provider-factory-test"},
    )
    ...
    assert captured_metadata == {
        ...
        "request_id": "external-readonly-answer-provider-factory-test",
    }
...
def test_external_readonly_answer_default_provider_factory_exports_are_explicit() -> None:
    assert external_readonly_answer_provider_factory.__all__ == [
        "DEFAULT_EXTERNAL_READONLY_ANSWER_LLM_INVOCATION_PROVIDER_FACTORY_REF",
        "ProductRuntimeAssemblyExternalReadonlyAnswerLlmInvocationServiceFactory",
        "build_external_readonly_answer_default_llm_invocation_service_factory",
    ]
